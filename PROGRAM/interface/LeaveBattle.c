...
void CalculateInfoData()
{
	...
	{
		totalInfo = XI_ConvertString("LeaveBattletotalInfo");
		sEnd = XI_ConvertString("LeaveBattletotalInfoEnd");
	}
	else
	{
		totalInfo = XI_ConvertString("LeaveBattletotalInfo2");
		sEnd = XI_ConvertString("LeaveBattletotalInfoEnd2");
	}
