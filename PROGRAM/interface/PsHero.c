...
void FillTable()
{
    ...
    GameInterface.TABLE_HERO.hr.td2.str = XI_ConvertString("PsHeroName");
	...
	GameInterface.TABLE_HERO.hr.td5.str = XI_ConvertString("ship1");
	GameInterface.TABLE_HERO.hr.td5.scale = 0.8;
	GameInterface.TABLE_HERO.hr.td6.str = XI_ConvertString("PsHeroLocation");
	GameInterface.TABLE_HERO.hr.td6.scale = 0.8;
	GameInterface.TABLE_HERO.hr.td7.str = XI_ConvertString("PsHeroDirection");
	...
	for (i = 1; i <= PsHeroQty; i++)
	{
	    ...
	    GameInterface.TABLE_HERO.(row).td2.str = GetFullNameTitulForm(chr);
