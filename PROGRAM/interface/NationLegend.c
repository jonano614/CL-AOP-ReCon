...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    totalInfo = XI_ConvertString(GetNationNameByType(Nation1)) + " " + XI_ConvertString("NationLegendText_4") + " " + XI_ConvertString(GetNationNameByType(Nation2));
    if(RelatNat == RELATION_FRIEND)
    {
        totalInfo = totalInfo + XI_ConvertString("NationLegendText_1");
    }
    if(RelatNat == RELATION_ENEMY)
    {
        totalInfo = totalInfo + XI_ConvertString("NationLegendText_2");
    }
    if(RelatNat == RELATION_NEUTRAL)
    {
        totalInfo = totalInfo + XI_ConvertString("NationLegendText_3");
    }
