...
void InitCannons()
{
	...
	rCannon.hp = 25.0;
	InitBaseCannons_CalcSpeedV0(&rCannon,375.0);
	...
	rCannon.hp = 40.0;
	InitBaseCannons_CalcSpeedV0(&rCannon,475.0);
	...
	//rCannon.TradeOff = true; /продаются
	rCannon.hp = 55.0;
	...
	rCannon.DamageMultiply = 0.7;
	rCannon.hp = 15.0;
	InitBaseCannons_CalcSpeedV0(&rCannon, 220.0);
	...
	rCannon.hp = 30.0;
	InitBaseCannons_CalcSpeedV0(&rCannon,325.0);
	...
	rCannon.SizeMultiply = 1.0;
	rCannon.HeightMultiply = 1.0;
	rCannon.TradeOff = true; //выключаем продажу
	rCannon.hp = 80.0;
