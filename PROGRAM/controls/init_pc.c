void ExternControlsInit(bool bFirst)
{
    ...
    CI_CreateAndSetControls( "", "TimeScaleFasterAlt", CI_GetKeyCode("VK_A_PLUS"), 0, false );
	CI_CreateAndSetControls( "", "TimeScaleSlowerAlt", CI_GetKeyCode("VK_A_MINUS"), 0, false );
...
//	MapControlToGroup("ChrRun","BattleInterfaceControls");
	...
	CI_CreateAndSetControls("PrimaryLand", "AlchemyKey", CI_GetKeyCode("KEY_K"), 0, false); // Интерфейс мультиобъектов
	...
	MapControlToGroup("AlchemyKey","FightModeControls");
...
// World map ===================================================================
	...
	CI_CreateAndSetControls( "Sailing1Pers", "Interface", CI_GetKeyCode("VK_F1"), 0, false );
	...
	CI_CreateAndSetControls( "Sailing1Pers", "CharacterShipMenu", CI_GetKeyCode("VK_F2"), 0, false );
	...
	MapControlToGroup("CharacterShipMenu","FightModeControls");
	CI_CreateAndSetControls( "Sailing1Pers", "LogbookMenu", CI_GetKeyCode("VK_F3"), 0, false );
	...
	MapControlToGroup("LogbookMenu","FightModeControls");
	CI_CreateAndSetControls( "Sailing1Pers", "ItemsMenu", CI_GetKeyCode("VK_F4"), 0, false );
	...
	MapControlToGroup("ItemsMenu","FightModeControls");
	CI_CreateAndSetControls( "Sailing1Pers", "NationsMenu", CI_GetKeyCode("VK_F5"), 0, false );
	...
	MapControlToGroup("NationsMenu","FightModeControls");
//	CI_CreateAndSetControls( "", "MainMenu", CI_GetKeyCode("VK_F1"), 0, false );
	...
	CI_CreateAndSetControls( "", "IExit_F3", CI_GetKeyCode("VK_F3"), 0, false );
	CI_CreateAndSetControls( "", "IExit_F4", CI_GetKeyCode("VK_F4"), 0, false );
	CI_CreateAndSetControls( "", "IExit_F5", CI_GetKeyCode("VK_F5"), 0, false );
	CI_CreateAndSetControls( "", "IExit_K", CI_GetKeyCode("KEY_K"), 0, false );
	...
	//HardCoffee дополнительные команды для активации меню "enter"
/*	CI_CreateAndSetControls("BattleInterfaceControls", "BICommandsActivateAdd", CI_GetKeyCode("VK_RETURN"), 0, true); //BattleInterfaceControls
	MapControlToGroup("BICommandsActivateAdd","Sailing1Pers");
	MapControlToGroup("BICommandsActivateAdd","Sailing3Pers");
	MapControlToGroup("BICommandsActivateAdd", "WorldMapControls");
	MapControlToGroup("BICommandsActivateAdd", "FightModeControls");
	MapControlToGroup("BICommandsActivateAdd","PrimaryLand");*/
	CI_CreateAndSetControls("BattleInterfaceControls", "BICommandsConfirm", CI_GetKeyCode("VK_RETURN"), 0, false);
	MapControlToGroup("BICommandsConfirm", "Sailing1Pers");
	MapControlToGroup("BICommandsConfirm", "Sailing3Pers");
	MapControlToGroup("BICommandsConfirm", "WorldMapControls");
	MapControlToGroup("BICommandsConfirm", "FightModeControls");
	MapControlToGroup("BICommandsConfirm","PrimaryLand");
/*	CI_CreateAndSetControls("BattleInterfaceControls", "BICommandsConfirmAdd", CI_GetKeyCode("VK_RETURN"), 0, true); //VK_LBUTTON
	MapControlToGroup("BICommandsConfirmAdd", "Sailing1Pers");
	MapControlToGroup("BICommandsConfirmAdd", "Sailing3Pers");
	MapControlToGroup("BICommandsConfirmAdd", "WorldMapControls");
	MapControlToGroup("BICommandsConfirmAdd", "FightModeControls");
	MapControlToGroup("BICommandsConfirmAdd","PrimaryLand");*/
	CI_CreateAndSetControls("BattleInterfaceControls", "BICommandsCancel", CI_GetKeyCode("VK_ESCAPE"), 0, false);
	MapControlToGroup("BICommandsCancel", "Sailing1Pers");
	MapControlToGroup("BICommandsCancel", "Sailing3Pers");
	MapControlToGroup("BICommandsCancel", "WorldMapControls");
	MapControlToGroup("BICommandsCancel", "FightModeControls");
	MapControlToGroup("BICommandsCancel", "PrimaryLand");
/*	CI_CreateAndSetControls("BattleInterfaceControls", "BICommandsCancelAdd", CI_GetKeyCode("VK_ESCAPE"), 0, true); //VK_RBUTTON
	MapControlToGroup("BICommandsCancelAdd", "Sailing1Pers");
	MapControlToGroup("BICommandsCancelAdd", "Sailing3Pers");
	MapControlToGroup("BICommandsCancelAdd", "WorldMapControls");
	MapControlToGroup("BICommandsCancelAdd", "FightModeControls");
	MapControlToGroup("BICommandsCancelAdd","PrimaryLand");*/
	...
	CI_CreateAndSetControls("Sailing3Pers", "hk_cabin", CI_GetKeyCode("KEY_X"), 0, true);
	MapControlToGroup("hk_cabin", "Sailing1Pers");
	MapControlToGroup("hk_cabin", "BattleInterfaceControls");
	MapControlToGroup("hk_Cabin", "PrimaryLand");
...
// Dialog =====================================================================
    ...
    CI_CreateAndSetControls("BattleInterfaceControls", "TimeScale", CI_GetKeyCode("KEY_R"), 0, false);
    AddControlToSettingsGroups("TimeScale");
	CI_CreateAndSetControls("BattleInterfaceControls", "TimeScaleFasterBA", CI_GetKeyCode("VK_A_PLUS"), 0, false);
    AddControlToSettingsGroups("TimeScaleFasterBA");
	CI_CreateAndSetControls("BattleInterfaceControls", "TimeScaleSlowerBA", CI_GetKeyCode("VK_A_MINUS"), 0, false);
    AddControlToSettingsGroups("TimeScaleSlowerBA");
    MapControlToGroup("TimeScale",       "SailingFire");
    MapControlToGroup("TimeScaleFaster", "SailingFire");
    MapControlToGroup("TimeScaleSlower", "SailingFire");

	CI_CreateAndSetControls("PrimaryLand", "MapView", CI_GetKeyCode("KEY_M"), 0, false); // Атлас карт
