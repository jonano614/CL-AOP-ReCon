...
// Вечер 20 часов
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,130,125,140);
    Weathers[n].SpecialLandFog.Height 			= 700;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.005;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.005;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.012;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 1;
...
// Вечер 21 час
	...
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
	Weathers[n].Sun.HeightAngle = -1.0;
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,120,120,135);
    Weathers[n].SpecialLandFog.Height 			= 2200;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.012;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.020;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.015;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 1;
...
// Вечер 22 часа
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,100,100,115);
...
// Вечер 23 часа
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,80,80,90);
    Weathers[n].SpecialLandFog.Height 			= 700;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.008;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.005;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.012;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 1;
