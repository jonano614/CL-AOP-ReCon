...
// Утро 6 часов
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0, 68, 70, 74);
    Weathers[n].SpecialLandFog.Height 			= 2200;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.020;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.020;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.017;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 0;
...
// Утро 7 часов						 
	...
	Weathers[n].Fog.IslandDensity = 0.0003;
	Weathers[n].Fog.SeaDensity = 0.00008;
	Weathers[n].Fog.Color = argb(0,40,57,67);
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,116,147,166);
    Weathers[n].SpecialLandFog.Height 			= 1700;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.015;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.012;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.012;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 0;
...
// Утро 8 часов						
	...
	Weathers[n].Fog.IslandDensity = 0.0003;
	Weathers[n].Fog.SeaDensity = 0.00008;
	Weathers[n].Fog.Color = argb(0,166,196,208);
    ...
    Weathers[n].SpecialLandFog.Color			= argb(0,120,170,190);
    Weathers[n].SpecialLandFog.Height 			= 700;
    Weathers[n].SpecialLandFog.Start 			= 0;
    Weathers[n].SpecialLandFog.Density 			= 0.006;
    Weathers[n].SpecialLandFog.IslandDensity 	= 0.006;
    Weathers[n].SpecialLandFog.SeaDensity 		= 0.010;
    Weathers[n].SpecialLandFog.Enable 			= true;
    Weathers[n].SpecialLandFog.Type				= 0;
...
// Утро 9 часов						
	...
	Weathers[n].Fog.IslandDensity = 0.0003;
	Weathers[n].Fog.SeaDensity = 0.00008;
	Weathers[n].Fog.Color = argb(0,66,97,117);
...
// Утро 10 часов						 
	...
	Weathers[n].Fog.IslandDensity = 0.0003;
	Weathers[n].Fog.SeaDensity = 0.00008;
	Weathers[n].Fog.Color = argb(0,130,160,170);
