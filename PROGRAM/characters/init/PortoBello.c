...
int CreatePortoBelloCharacters(int n)
{
	...
	makeref(ch,Characters[n]);			//Трактирщик Пицарро
	ch.id		= "PortoBello_tavernkeeper";
	ch.model	= "Pizarro";
	ch.model.animation = "man";
	ch.name 	= FindPersonalName("PortoBello_tavernkeeper_name");
	ch.lastname = FindPersonalName("PortoBello_tavernkeeper_lastname");
	...
	ch.id		= "PortoBello_GlavSklad";
	ch.model	= "citiz_13";
	ch.sex = "man";
	ch.City = "PortoBello";
	ch.location	= "PortoBello_PackhouseOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "PortoBello_bankvault";
	ch.model	= "citiz_16";
	ch.sex = "man";
	ch.City = "PortoBello";
	ch.location	= "PortoBello_bankvault";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	ch.Dialog.Filename = "House_dialog.c";
