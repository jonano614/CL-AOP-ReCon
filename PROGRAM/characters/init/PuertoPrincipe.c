...
int CreatePuertoPrincipeCharacters(int n)
{
	...
	ch.sex = "man";
	ch.model = "Richard_Sawkins";
	ch.name = FindPersonalName("Richard_Soukins_name");
	ch.lastname = FindPersonalName("Richard_Soukins_lastname");
	...
	ch.name		= FindPersonalName("PuertoPrincipe_trader_name");
	ch.lastname = FindPersonalName("PuertoPrincipe_trader_lastname");
	ch.model	= "trader_11";
