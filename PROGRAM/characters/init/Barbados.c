...
int CreateBarbadosCharacters(int n)
{
	...
	ch.name		= FindPersonalName("Bridgetown_Hostess_name");
	ch.lastname = FindPersonalName("Bridgetown_Hostess_lastname");
	ch.model	= "Maman_4";
	...
	ch.id		= "Bridgetown_GlavSklad";
	ch.model	= "citiz_12";
	ch.sex = "man";
	ch.City = "Bridgetown";
	ch.location	= "Bridgetown_PackhouseOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "Bridgetown_bankvault";
	ch.model	= "citiz_19";
	ch.sex = "man";
	ch.City = "Bridgetown";
	ch.location	= "Bridgetown_bankvault";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	ch.Dialog.Filename = "House_dialog.c";
