...
int CreateStoryCharacters(int n)
{
	...
	ch.name 	= FindPersonalName("eng_guber_name");
	ch.lastname = FindPersonalName("eng_guber_lastname");
	ch.id		= "eng_guber";
	ch.model	= "Modyford";
...
//	ch.notQuestLine = true; //флаг не давать задания по линейке
	...
	ch.name 	= FindPersonalName("spa_guber_name");
	//ch.middlename = "";
	ch.lastname = FindPersonalName("spa_guber_lastname");
	ch.id		= "spa_guber";
	ch.model	= "Gaskon";
	ch.model.animation	= "man";
	ch.sex = "man";
	...
	ch.name 	= FindPersonalName("fra_guber_name");
	ch.lastname = FindPersonalName("fra_guber_lastname");
	ch.id		= "fra_guber";
	ch.model	= "dOgeron";
	ch.sex = "man";
	...
	ch.name 	= FindPersonalName("hol_guber_name");
	ch.lastname = FindPersonalName("hol_guber_lastname");
	ch.id		= "hol_guber";
	ch.model	= "stuvesant";
	ch.sex = "man";
...
//============== Генри Морган! Всем трепетать. =================
	...
	ch.name 	= FindPersonalName("Henry_Morgan_name");
	ch.lastname = FindPersonalName("Henry_Morgan_lastname");
	ch.id		= "Henry Morgan";
	ch.model	= "Morgan";
	ch.model.animation = "man";
	ch.sex = "man";
	...
	ch.Ship.Name = FindPersonalName("Henry_Morgan_ship");
	ch.Ship.Type = GenerateShipExt(SHIP_FRIGATE, true, ch);
	ch.Ship.Stopped = true;
   	ch.Ship.Cannons.Type = CANNON_TYPE_CANNON_LBS42;	// evganat - пасха
...
//============== Секретать Моргана, можно расслабиться. =================
	makeref(ch,Characters[n]);
	ch.name 	= FindPersonalName("Oliver_Green_name");
	ch.lastname = FindPersonalName("Oliver_Green_lastname");
	ch.id		= "Oliver_Green";
	ch.model	= "Helper";
	ch.sex = "man";
    ch.model.animation = "man";
	...
	ch.name 	= FindPersonalName("Isabella_name");
	ch.lastname = FindPersonalName("Isabella_lastname");
	ch.id		= "Isabella";
	ch.model	= "liza";
	ch.sex = "woman";
...
//	LAi_group_MoveCharacter(ch, "SPAIN_CITIZENS");
	...
	ch.name 	= FindPersonalName("Ascold_name");
	ch.lastname = "";
	ch.id		= "Ascold";
	ch.model	= "Ascoldit";
...
//============== Капитан Бартоломью Шарп =================
    makeref(ch,Characters[n]);
	ch.name 	= FindPersonalName("Sharp_name");
	ch.lastname = FindPersonalName("Sharp_lastname");
	ch.id		= "Sharp";
	ch.model	= "Bartholomew_Sharp";
	ch.sex = "man";
	ch.location	= "none";
	ch.location.group = "";
	ch.location.locator = "";
	...
	// ==> Кораблик 
	ch.Ship.Name = FindPersonalName("Sharp_ship");
	...
	ch.DontRansackCaptain = true; //fix
