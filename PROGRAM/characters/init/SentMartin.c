...
int CreateSentMartinCharacters(int n)
{
	...
	ch.name		= FindPersonalName("Marigo_Hostess_name");
	ch.lastname = "";
	ch.model	= "Maman_6";
	...
	ch.id		= "Marigo_GlavSklad";
	ch.model	= "citiz_11";
	ch.sex = "man";
	ch.City = "Marigo";
	ch.location	= "Marigo_PackhouseOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "Marigo_bankvault";
	ch.model	= "citiz_12";
	ch.sex = "man";
	ch.City = "Marigo";
	ch.location	= "Marigo_bankvault";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	ch.Dialog.Filename = "House_dialog.c";
