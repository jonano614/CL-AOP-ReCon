	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(
						StringFromKey("Havana_cemetery_3", RandPhraseSimple(
								StringFromKey("Havana_cemetery_1"),
								StringFromKey("Havana_cemetery_2"))),
						StringFromKey("Havana_cemetery_4", GetAddress_Form(NPChar)),
						StringFromKey("Havana_cemetery_5"),
						StringFromKey("Havana_cemetery_6"), "block", 1, npchar, Dialog.CurrentNode);
			link.l1 = HeroStringReactionRepeat(
						StringFromKey("Havana_cemetery_9", RandPhraseSimple(
								StringFromKey("Havana_cemetery_7", pchar),
								StringFromKey("Havana_cemetery_8"))),
						StringFromKey("Havana_cemetery_10"),
						StringFromKey("Havana_cemetery_11"),
						StringFromKey("Havana_cemetery_12"), npchar, Dialog.CurrentNode);
			link.l1.go = "exit";
			if (!CheckAttribute(NPChar, "talkedLSC") && CheckAttribute(pchar, "questTemp.LSC") && pchar.questTemp.LSC == "UndertakersSurveyLSC")
			{
				NPChar.talkedLSC = 1;
				link.l1 = StringFromKey("Havana_cemetery_13");
				link.l1.go = "HavanaCemeteryLSC_1";
			}
		/* // калеуче
		...
		case "HavanaCemeteryLSC_1":
			dialog.text = StringFromKey("Havana_cemetery_14");
			link.l1 = "...";
			link.l1.go = "HavanaCemeteryLSC_2";
		break;
		case "HavanaCemeteryLSC_2":
			dialog.text = StringFromKey("Havana_cemetery_15");
			link.l1 = StringFromKey("Havana_cemetery_16");
			link.l1.go = "exit";
